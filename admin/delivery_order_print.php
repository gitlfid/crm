...
// 2. AMBIL ITEM (Prioritas: Tabel delivery_order_items)
$itemsData = [];
...
if ($resDOItems && $resDOItems->num_rows > 0) {
    ...
    // Fallback Invoice (Jika user belum pernah klik SAVE di form DO)
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        /* PAGE SETTINGS AGAR TIDAK KEPOTONG */
        @page { 
            margin: 1cm; 
            size: A4; 
        }
        
        /* WRAPPER AGAR ISI TENGAH DAN AMAN DARI PINGGIR KERTAS */
        .page-content {
            padding: 0 10px;
            width: 100%;
        }
        ...
        .footer-col { vertical-align: bottom; padding: 10px; } /* Align Bottom agar sejajar */
        ...
        /* SIGNATURE STYLE (LARGE & PROPORTIONAL) */
        .sign-title { font-weight: bold; margin-bottom: 5px; text-decoration: underline; font-size: 11px; display: block; }
        .sign-area { 
        ...
        .sign-img { 
            max-width: 100%;   
            max-height: 150px; /* Batas Tinggi Gambar */
            width: auto; height: auto;
            object-fit: contain; /* Agar tidak gepeng */
            display: block;
        }
        ...
        .sign-line { border-bottom: 1px solid #000; width: 80%; margin: 0 auto; margin-bottom: 5px;} /* Garis manual */
...
<body>
    ...
    <div class="no-print">
        ...
        <div style="margin-top: 5px; color: red; font-size: 10px;">
            * Tips: Hapus centang "Headers and footers" di setting print browser agar URL hilang.
        </div>
    </div>
