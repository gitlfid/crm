...
// --- 2. QUERY UTAMA (FIXED: Tambah Join u2 untuk PIC) ---
$sql = "SELECT t.*, 
...
if (!empty($search_keyword)) {
    ...
    // Tambahkan pencarian ke nama PIC (u2.username) juga
...
<style>
    ...
    .table-compact thead th {
        background-color: #f4f6f8; color: #637381; font-weight: 600; font-size: 0.85rem;
        text-transform: uppercase; letter-spacing: 0.5px; padding: 12px 16px; border-bottom: 1px solid #dfe3e8;
    }
    .table-compact tbody td {
        padding: 10px 16px; vertical-align: middle; border-bottom: 1px dashed #eff2f5; color: #212b36;
    }
    .ticket-code { font-family: 'Consolas', 'Monaco', monospace; font-weight: 700; color: #435ebe; }
    .avatar-initial {
        width: 32px; height: 32px; background-color: #dfe3e8; color: #637381;
        display: flex; align-items: center; justify-content: center; border-radius: 50%; font-weight: 600; font-size: 0.8rem;
    }
    ...
    .badge-hold { background-color: #e0f7fa; color: #00bcd4; }
    .badge-canceled { background-color: #ffebee; color: #f44336; }
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php 
                                        ...
                                        elseif($st == 'hold') $badgeClass = 'badge-hold';
                                        elseif($st == 'canceled') $badgeClass = 'badge-canceled';
                                    ?>
