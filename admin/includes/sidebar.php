...
if ($role_name === 'admin') {
    ...
    $sidebar_menu['ops'] = ['menu_label' => 'Telkomsel Ops', 'url' => '#', 'icon' => 'bi bi-broadcast-pin', 'children' => [['menu_label' => 'Inject Dashboard', 'url' => 'tsel_dashboard.php'], 'children' => [['menu_label' => 'Package List', 'url' => 'tsel_packages.php'], ['menu_label' => 'Inject Data', 'url' => 'tsel_inject.php']]];
} 
