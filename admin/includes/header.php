...
### 2. `sidebar.php` (Fix Layout Sampingan dengan Header)
File ini mencetak `aside` di kolom kiri, lalu membuat *container* `div` untuk kolom kanan, mencetak Top Navbar di bagian atasnya, dan menyisakan kotak bawah untuk halaman Dashboard Anda.
